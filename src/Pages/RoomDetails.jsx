    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
           <h1 className='text-3xl md:text-4xl font-playfair'>
            {room.hotel.name}<span className='font-inter text-sm'>
           ...
           md:items-center gap-4 md:gap-10 text-gray-500'>
               ...
               <div className='w-px-h-15 bg-gray-300/70 max-md:hidden'></div>
                ...
                <div className = 'flex flex-col'>
                  ...
                  className='max-w-20 rounded border border-gray-300 px-2 mt-1.5 outline-none'
                   required />
               </div>
            ...
            <button
  type='submit'
  className='bg-blue-600 hover:bg-blue-700 active:scale-95 transition-all text-white rounded-md w-full md:w-auto md:px-10 py-3 text-base font-medium'
>
  Check Availability
</button>
...
{/* common Specification */}
    <div className ='mt-25 space-y-4'>
      {roomCommonData.map((spec,index)=>(
       ...
       <p>
        ...
        The price quoted is for two guests, at the guest slot please mark the number of guests to get
         the exact price for groups. The Guests will be allocated ground floor according to availability.
  ...
  {/* Hosted by */}
      ...
      hover: bg-blue-700 transition-all cursor-pointer '>Contact Now</button>
