    ...
    xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantage of our limited-time offers and special packages to enchance
                     your stay and create unforgettable memories. </p>

            </div>
 
           {roomsDummyData.map((room)=>(
            <div key={room._id}className='flex flex-col md:flex-row items-start py-6 gap-6
            border-b border-gray-300 last:pb-30 last:border-0'>
             ...
             className="w-full md:w-[300px] h-[200px] object-cover rounded-xl shadow-lg cursor-pointer" />
